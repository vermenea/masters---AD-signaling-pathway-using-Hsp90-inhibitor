...
from pstat1_data import data as pstat1_data
...
control_ps1 = pstat1_data["control"][0]
stimulation_ps1 = pstat1_data["stimulation"][0]
treatment_01_ps1 = pstat1_data["0.1MM_treatment"][0]
treatment_1_ps1 = pstat1_data["1MM_treatment"][0]

normalized_control = control_beta_actin / control_ps1 
normalized_stimulation = stimulation_beta_actin / stimulation_ps1 
normalized_treatment_01 = treatment_01_beta_actin / treatment_01_ps1
normalized_treatment_1 = treatment_1_beta_actin / treatment_1_ps1
...
plt.xlabel('Normalized pSTAT1 Levels with Beta-actin')
