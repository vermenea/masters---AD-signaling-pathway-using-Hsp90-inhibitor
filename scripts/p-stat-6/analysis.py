...
from pstat6_data import pstat6_data, means_df  # Updated import for stat-6
...
normalized_control = [control_beta_actin / p for p in pstat6_data["control"]]  # Updated to pstat6_data
normalized_stimulation = [stimulation_beta_actin / p for p in pstat6_data["stimulation"]]  # Updated to pstat6_data
normalized_treatment_01 = [treatment_01_beta_actin / p for p in pstat6_data["0.1MM_treatment"]]  # Updated to pstat6_data
normalized_treatment_1 = [treatment_1_beta_actin / p for p in pstat6_data["1MM_treatment"]]  # Updated to pstat6_data
...
if all(p > 0.05 for p in p_values_shapiro) and p_levene > 0.05:
    ...
    stat, p_welch = stats.ttest_ind(normalized_control, normalized_stimulation, equal_var=False)
    print("\n"f'Welch ANOVA - Statistic: {stat}, p-value: {p_welch}')
else:
